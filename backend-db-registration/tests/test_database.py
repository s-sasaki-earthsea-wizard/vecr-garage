...
from db.database import (
    get_human_member_by_name,
    get_virtual_member_by_name,
    save_human_member,
    save_virtual_member,
)
...
def db_session():
    ...
    with engine.connect() as conn:
        ...
        truncate_sql = text(
            "TRUNCATE TABLE human_member_profiles, virtual_member_profiles, virtual_members, human_members RESTART IDENTITY CASCADE"
        )
